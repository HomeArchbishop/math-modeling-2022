...
const baseURL = 'https://api.bilibili.com/x/space/arc/search'
...
const interval = setInterval(() => {
  ...
  if (!name) {
    ...
    fs.writeFileSync(resolve(__dirname, '../results/counts/count.json'), JSON.stringify(viewData, null, 2))
    return
  }
