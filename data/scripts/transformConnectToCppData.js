...
fs.writeFileSync(resolve(__dirname, '../results/attactions/cpp-data/cppDataShort.txt'), cppDataShortTxt)
...
fs.writeFileSync(resolve(__dirname, '../results/attactions/cpp-data/cppDataTX.txt'), cppDataTxtTX)
